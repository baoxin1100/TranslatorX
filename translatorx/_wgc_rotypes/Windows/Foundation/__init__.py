...
from translatorx._wgc_rotypes import delegate, HSTRING
from translatorx._wgc_rotypes.idldsl import define_winrt_com_method, generics_cache, define_winrt_com_delegate, pinterface_type, \
    GUID
